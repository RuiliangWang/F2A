...
"../5MW_Baseline/NRELOffshrBsline5MW_InflowWind_11.4mpsF2AValid.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
...
"NRELOffshrBsline5MW_OC3Hywind_HydroDyn_F2AVald.dat"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"unused"      SubFile         - Name of file containing sub-structural input parameters (quoted string)
"NRELOffshrBsline5MW_OC3Hywind_FEAMooring.dat"    MooringFile     - Name of file containing mooring system input parameters (quoted string)

...
---------------------- PLATFORM ------------------------------------------------
   1        PtfmModel   - Platform model {0: none, 1: onshore, 2: fixed bottom offshore, 3: floating offshore} (switch)
"FAST_Config\NRELOffshrBsline5MW_Platform_OC3Hywind_AQWA.dat"     PtfmFile    - Name of file containing platform properties (quoted string) [unused when PtfmModel=0]
---------------------- TOWER ---------------------------------------------------
  20        TwrNodes    - Number of tower nodes used for analysis (-)
"FAST_Config\NRELOffshrBsline5MW_Tower_OC3Hywind.dat"        TwrFile     - Name of file containing tower properties (quoted string)
---------------------- NACELLE-YAW ---------------------------------------------
...
---------------------- BLADE ---------------------------------------------------
"FAST_Config\NRELOffshrBsline5MW_Blade.dat"                  BldFile(1)  - Name of file containing properties for blade 1 (quoted string)
"FAST_Config\NRELOffshrBsline5MW_Blade.dat"                  BldFile(2)  - Name of file containing properties for blade 2 (quoted string)
"FAST_Config\NRELOffshrBsline5MW_Blade.dat"                  BldFile(3)  - Name of file containing properties for blade 3 (quoted string) [unused for 2 blades]
---------------------- AERODYN -------------------------------------------------
"FAST_Config\NRELOffshrBsline5MW_AeroDyn_Turb_114.ipt"                ADFile      - Name of file containing AeroDyn input parameters (quoted string)
---------------------- NOISE ---------------------------------------------------
"Dummy"     NoiseFile   - Name of file containing aerodynamic noise input parameters (quoted string) [used only when CompNoise=True]
---------------------- ADAMS ---------------------------------------------------
"FAST_Config\NRELOffshrBsline5MW_ADAMSSpecific.dat"          ADAMSFile   - Name of file containing ADAMS-specific input parameters (quoted string) [unused when ADAMSPrep=1]
---------------------- LINEARIZATION CONTROL -----------------------------------
"FAST_Config\NRELOffshrBsline5MW_Linear.dat"                 LinFile     - Name of file containing FAST linearization parameters (quoted string) [unused when AnalMode=1]
---------------------- Seismic loading -----------------------------------
False		SeismicLdMode			- The flag of seismic loads calculation. (Ture: with earthquake,False: without earthquake)
"FAST_Config\DTU10MW_Monopile_Seismic_Kobe.dat"                 SeismicFile     - Name of file containing seismic configuration
---------------------- Soil-Structure Interaction -----------------------------------
1		SSIMode				- Model for SSI (0: none, 1: Coupled Springs (Wolf method), 2: Coupled Springs (Specified stiffness and damping),3: Distributed Springs)
150.0            ShrModuSoil      		- The shear modulus of local soil (Unit:MPa) [Only used when SSIMode = 1]
1800.0           DenSoil           		- The denisty of local soil (Unit: kg/m^3) [Only used when SSIMode = 1]
0.333           PoissRatio        		- The poisson ratio of local soil (Unit: -) [Only used when SSIMode = 1]
6.0             RadiusPtfm        		- The radius of platform (Unit: m) [Only used when SSIMode = 1]
"FAST_Config\SSIData\OC3PhraseII_SoilStiffness_CS.dat"	InFileGKCM	     - Input file for specified stiffness and damping matrices mode. The file contains the stiffness and damping and added-mass matric
"FAST_Config\SSIData\StiffnessDSModel_10MW30mWD.dat"	InFileDS	     - Input file for DS model whicn defines the stiffness distribution for a pile [Only used when SSIMode = 3]
"FAST_Config\SSIData\pyCurve_data.dat"                  InFileNonlinear	     - Input file for nonlinear DS model using p-y curves
--------------------- Structural Control -----------------------------------
False 		StrcCtrlMode			- The flag of structural control. (Ture: activate the TMD control,False: no structural control)
"FAST_Config\DTU10MW_Monopile_TMDControl.dat"                 StrcCtrlFile     - Name of the file containing TMD control configurations.
--------------------- Bladed style DLL -----------------------------------
"FAST_Config\ServoData\DISCON_x64_Spar.dll"	DLL_FileName		- DLL file name including the extension
"DISCON"			DLL_ProcName		- Program name of the DLL control subroutine		
"FAST_Config\ServoData\DISCON.IN"			DLL_InFile		- Input file name of the DLL in which the control parameters are defined
---------------------- OUTPUT --------------------------------------------------
